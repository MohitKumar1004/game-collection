...
function NinjaNakamoto() {
    ...
    class Sprite {
        constructor({position, imageSrc, can, draw_ }) {
        ...
        draw() {
            this.draw_.drawImage(this.image, this.position.x, this.position.y)
        }
    ...
    class Fighter {
        ...
        update() {
            ...
            if(this.position.y + this.height + this.velocity.y >= this.can.height){
