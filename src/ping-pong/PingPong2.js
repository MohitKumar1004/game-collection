...
export default function PingPong2() {
    ...
    const [noofthreads,setNoofthreads] = useState(0)
    const [stop,setStop] = useState(false)
        ...
        function start(){
            ...
            {
                setStop(true);
                setTimeout(function(){console.log("Stopping");},10);
                return;
            }
            setGameButton('Reset Game')
    ...
    return (
        <StyledWrapper>
            ...
            <StyledButton onClick={start}>{gameButton}</StyledButton>
        </StyledWrapper>
    )
}
